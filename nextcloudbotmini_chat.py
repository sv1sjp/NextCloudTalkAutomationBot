...
/_/  \__,_/_/_/|_/_____/\____/\__/ 
    ...
    version_info = "Version 1.03 Mini - Powered by TuxHouse - This is a shorted version find the full version here: https://github.com/sv1sjp/NextCloudTalkAutomationBot"
    
    print(Fore.GREEN + banner)
    print(Fore.CYAN + version_info)
    print(Style.BRIGHT + Fore.MAGENTA + "Fast, Secure, and Focused on Messaging.")
    print(Fore.RED + "-----------------------------------------------")
